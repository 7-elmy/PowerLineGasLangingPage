...
// export default function AddEmployeeform3({setBorder= false ,setButton= true ,formik}) {
...
//     console.log(`Section ${id} - ${fieldName} Selected Date:`, dateString);
    
//     // Update the specific document section's date
...
//       setDocumentSections(documentSections.filter(section => section.id !== idToRemove));
//     }
//   };

//   return (
//     <div className={setBorder== true?"border border-Neutral-600 rounded-[12px] px-8 mx-3 pb-8":""}>
...
//         </div>
//       ))}
//         {setButton == true ? <div className='col-span-12 flex justify-center items-center mt-6'>
//         <button 
//           onClick={addNewDocumentSection}
//           className='text-Primary-400 p-3 border-Primary-400 border rounded-md hover:bg-blue-50 transition-colors'
//         >
...
//   setDocuments
// }) {
//   // Use provided documents or initialize with a default empty document
//   const [documentSections, setDocumentSections] = useState(
...
//   // Sync documents with parent component when they change
//   useEffect(() => {
//     if (setDocuments) {
//       setDocuments(documentSections);
//     }
//   }, [documentSections, setDocuments]);
...
//               image={image}
//               onChange={(file) => handleDocumentUpload(section.id, file)}
//               value={section.document ? section.document.name : ''}
//             />
//           </div>
...
//       formik?.setFieldValue('documents', documentSections);
//     }
//   }, [documentSections, setDocuments, formik]);
...
//               label={"Documents*"} 
//               image={image}
//               name={`document-${section.id}`}
//               onChange={(file) => handleDocumentUpload(section.id, file)}
//               value={section.document ? section.document.name : ''}
//               error={formik?.errors?.documents?.[index]?.document}
//               touched={formik?.touched?.documents?.[index]?.document}
//             />
//           </div>
